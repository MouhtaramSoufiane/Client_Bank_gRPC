...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest,
      ma.enset.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "convert",
      requestType = ma.enset.stubs.Bank.ConverCurrencyRequest.class,
      responseType = ma.enset.stubs.Bank.ConvertCurrencyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest,
      ma.enset.stubs.Bank.ConvertCurrencyResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest, ma.enset.stubs.Bank.ConvertCurrencyResponse> getConvertMethod;
    if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
      synchronized (BankServiceGrpc.class) {
        if ((getConvertMethod = BankServiceGrpc.getConvertMethod) == null) {
          BankServiceGrpc.getConvertMethod = getConvertMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Bank.ConverCurrencyRequest, ma.enset.stubs.Bank.ConvertCurrencyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "BankService", "convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Bank.ConverCurrencyRequest.getDefaultInstance()))
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest,
      ma.enset.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest, ma.enset.stubs.Bank.ConvertCurrencyResponse> getGetCurrencyStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest,
      ma.enset.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest, ma.enset.stubs.Bank.ConvertCurrencyResponse> getPerformStreamMethod;
  ...
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest,
      ma.enset.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Bank.ConverCurrencyRequest, ma.enset.stubs.Bank.ConvertCurrencyResponse> getFullCurrencyStreamMethod;
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void convert(ma.enset.stubs.Bank.ConverCurrencyRequest request,
     ...
     * </pre>
     */
    public void getCurrencyStream(ma.enset.stubs.Bank.ConverCurrencyRequest request,
        io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConverCurrencyRequest> performStream(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConverCurrencyRequest> fullCurrencyStream(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConvertCurrencyResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ma.enset.stubs.Bank.ConverCurrencyRequest,
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractStub<BankServiceBlockingStub> {
     ...
     * </pre>
     */
    public ma.enset.stubs.Bank.ConvertCurrencyResponse convert(ma.enset.stubs.Bank.ConverCurrencyRequest request) {
    ...
    public java.util.Iterator<ma.enset.stubs.Bank.ConvertCurrencyResponse> getCurrencyStream(
        ma.enset.stubs.Bank.ConverCurrencyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((ma.enset.stubs.Bank.ConverCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        case METHODID_GET_CURRENCY_STREAM:
          serviceImpl.getCurrencyStream((ma.enset.stubs.Bank.ConverCurrencyRequest) request,
              (io.grpc.stub.StreamObserver<ma.enset.stubs.Bank.ConvertCurrencyResponse>) responseObserver);
          break;
        default:
